                    ...
                    <div className={ToggleState === 1 ? "qualification__content qualification__content-active" : "qualification__content"}>
                        ...
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">Bachelor of Science</span>
                                <span className="qualification__subtitle">North Western University</span>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className="qualification__subtitle">Govt. Sundarban Adarsha College</span>
                                <div className="qualification__calender">
                        ...
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">Lions School & College</span>
                                <div className="qualification__calender">

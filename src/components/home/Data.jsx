...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Hasan Jamil
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">Passionate full-stack web developer with a proven ability to learn quickly and apply new skills. Seeking a challenging position where I can utilize my skills and knowledge to contribute to the development of innovative web applications.</p>
